...
class Network(nn.Module):
    def __init__(self, input_channel=512, layers=[5, 5, 5], num_classes=11):
        self.inplanes3 = 64
        self.inplanes5 = 64
        self.inplanes7 = 64
        ...
        self.lstm = nn.LSTM(input_size=64, hidden_size=128, num_layers=layers[3], batch_first=True,
    ...
    def forward(self, x0, seq_lens=[512*int(202)]):
        x0 = x0.unsqueeze(0)
        x0 = x0.permute(0,2,1)
        x0 = self.conv1(x0)
        x0 = self.bn1(x0)
